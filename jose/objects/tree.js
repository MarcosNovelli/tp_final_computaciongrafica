...
function createTreeMesh(gl) {
  ...
  return {
    ...
    trunkIndexCount: trunkIndexCount, // Índices del tronco (para renderizar por separado)
    crownIndexCount: indices.length - trunkIndexCount, // Índices de la copa
    crownIndexOffset: trunkIndexCount // Offset donde empiezan los índices de la copa
  };
}
